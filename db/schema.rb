...
ActiveRecord::Schema.define(version: 20160407064517) do
  ...
  add_index "survey_answers", ["course_id"], name: "index_survey_answers_on_course_id"
  ...
  add_index "survey_surveys", ["course_id"], name: "index_survey_surveys_on_course_id"
